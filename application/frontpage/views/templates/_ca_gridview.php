...
<fieldset>
    ...
    <ul>
        ...
        <!--<li><a href="<?php echo $this->ca_gridview->shape_uri_segment(array('offset'=>0),'',array('export'=>'xls')) ?>" target="_blank">XLS</a></li>-->
    </ul>
</fieldset>
<?php endif; ?>
...
<?php if($set_pagination && $this->ca_gridview->is_exist_uri_segment('search_result')!='enable'): ?>  	  
<center>
<div class="ca-pagenavi ca-clearfix">
	<div class="pagenavi ca-clearfix">
		<?php echo $set_pagination ?> <span class="info"><?php echo $this->lang->line('ca_total_result') ?><?php echo $this->ca_gridview->total_result ?></span>
	</div>
</div>
</center>  
<?php endif; ?>
        	...
        	<th>
        		...
        		<?php if($this->ca_gridview->is_exist_uri_segment('search_result')!='enable'): ?>
	        		<?php if($this->ca_gridview->is_sortable($field)): ?>
	        			<a href="<?php echo $this->ca_gridview->display_url_asc($field) ?>"><?php echo image('ca_gridview/asc.png')?></a>
	        			<a href="<?php echo $this->ca_gridview->display_url_desc($field) ?>"><?php echo image('ca_gridview/desc.png')?></a>
	        		<?php endif; ?>
        		<?php endif; ?>
